...
export const HvAppleIcon: React.FC<IProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill='currentColor' width="24" height="24" viewBox="0 0 24 24" className={className}>
    ...
    <path
      ...
      transform="translate(3.621 7)"
    />
    <path
      d="M3.712,0a4.022,4.022,0,0,1-.88,2.95A3.578,3.578,0,0,1,.042,4.37a3.719,3.719,0,0,1,.9-2.88A4.346,4.346,0,0,1,3.712,0Z"
      transform="translate(12.128 2)"
    />

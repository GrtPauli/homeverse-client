...
const register = (conn: AgoraChat.Connection) => {
    ...
    getToken()
    .then(rs => {
        postData('http://a41.chat.agora.io/411020257/1191665/users', 
    ...
    <div className='p-10'>
        {/* {!userExists ? ( */}
            <div className='flex items-center gap-5 mb-10'>
                ...
                <p>Or</p>
                <Button title="Login" fullWidth={false} onClick={() => {setUserExists(true); login(conn)}}/> 
            </div>
        {/* ) : ( */}
            <div className='flex items-center gap-5 mb-10'>
                ...
                <Button title="Send Contact Request" fullWidth={false} onClick={() => sendContactRequest(conn)}/> 
            </div>
        {/* )} */}
    </div>
  )

...
export const SellWithAgent = () => {
  return (
    <div className='py-20 px-16 bg-light-white'>
      <h1 className='text-dark-prussian-blue font-extrabold text-3xl'>Sell Traditionally With an Agent</h1>
      <p className='mt-4 text-colors-cadet'>
        Not in a market with Zillow’s new selling experience?
        Work with a real estate agent for selling support at every step,
      ...
      <div className='mt-10 flex justify-between'>
        <div className='flex flex-col justify-between'>
          <div>
            <h1 className='font-bold mb-4 text-dark-prussian-blue text-xl'>Why Sell Traditionally</h1>
          ...
          <div>
            <button 
              className='bg-primary py-4 px-10 rounded text-light-white flex justify-center items-center font-bold'
            >
              Find an Agent
            </button>
          </div>

    ...
    <div className='mt-14'>
      ...
      <div className='border-b pb-4'>
        ...
        <div className='flex justify-between mt-1 items-end'>
            <p className='text-colors-cadet text-sm'>This will shut down your account, but retain your information. You won't be able to sign in again until your account is reactivated.</p>

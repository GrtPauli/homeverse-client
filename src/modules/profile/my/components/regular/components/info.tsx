      ...
      <div>
        ...
        <div className='border-b pb-4'>
          ...
          <div className='flex justify-between mt-1 items-end'>
            <p className='text-colors-cadet text-sm'>Your first and last given names. Updates are reflected immediately.</p>
...
{/* 
        <div className='border-b pb-4 mt-4'>
          ...
          <div className='flex justify-between mt-1'>
            <p className='text-colors-cadet text-sm'></p>
            <div className='flex gap-5 items-center'>
              <p className='text-sm'></p>
              <button 
                onClick={() => setShowModal({content: "screen-name", open: true})} 
                className='text-primary font-bold'
              >
                Edit
              </button>            
        ...
        <div className='border-b pb-4 mt-4'>
          ...
          <div className='flex justify-between items-end -mt-2'>
            <p className='text-colors-cadet text-sm'>Personalize your profile pic with a custom photo.</p>
            <div className='flex gap-5 items-center'>
              <Image
        ...
        <div className='border-b pb-4 mt-4'>
          ...
          <div className='flex justify-between mt-1 items-end'>
            <p className='text-colors-cadet text-sm'>Manage the reviews you’ve written for professionals, rentals, and more.</p>

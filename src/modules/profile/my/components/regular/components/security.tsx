    ...
    <div className='mt-14'>
      ...
      <div className='border-b pb-4'>
        ...
        <div className='flex justify-between mt-1 items-end'>
          <p className='text-colors-cadet text-sm'>The email address associated with your account.</p>
      ...
      <div className='border-b pb-4 mt-4'>
        ...
        <div className='flex justify-between mt-1 items-end'>
          <p className='text-colors-cadet text-sm'>Set a unique password to protect your account.</p>
            <button 
      ...
      <div className='border-b pb-4 mt-4'>
        ...
        <div className='flex justify-between mt-1 items-end'>
          <p className='text-colors-cadet text-sm'>Make your account extra secure. Along with your password, you'll need to enter a code that we text to your phone each time you sign in.</p>

  ...
  return (
    <div className={`border-b pb-5 ${index == 0 ? "mt-2" : "mt-5"} flex justify-between items-center`}>
        ...
        <div className='flex flex-col'>
            <h1 className='font-bold text-xl text-dark-prussian-blue mb-1'>{contactRequest?.firstname} {contactRequest?.lastname}</h1>
            <p className=''>+2349134102236</p>
        </div>
        </div>

        <div className='flex items-center gap-5'>
            <button onClick={() => acceptContactRequest(contactRequest._id)}

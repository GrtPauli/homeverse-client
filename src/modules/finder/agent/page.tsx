  ...
  return (
    <FinderLayout page='agents'>
      <div className='px-12 py-10'>
        ...
        <p className='text-colors-cadet mb-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore nam harum facere repellat, quidem quae. Consectetur repudiandae quod dolores nisi?</p>
        <div className='w-full py-10 bg-dark-prussian-blue'>
        ...
        <div className='flex gap-10 pt-10 items-start'>
          ...
          <div className='flex flex-col gap-5 w-[60%]'>
...

            {
              !loading && (
                agents.map((agent, i) => (
                  <div key={i} className='py-5 px-5 shadow-md rounded w-full bg-light-white flex justify-between items-start'>
                    <div className='flex gap-5 items-center'>
                      ...
                      <div className='flex flex-col'>
                        <h1 className='font-bold text-xl text-dark-prussian-blue mb-1'>{agent?.firstname} {agent?.lastname}</h1>

  ...
  return (
    ...
    <div className="flex flex-col gap-1 justify-between w-full">
      <div className="flex justify-between items-start">
        ...
        <p className="text-[11px] text-colors-cadet">{moment(item?.updatedAt).format(APP_DATE_TIME_FORMAT)}</p>
      </div>

      <div className="flex justify-between items-end">
        <p className="text-[13px] text-colors-cadet">{item?.message === "CTSC" ? "Click to start conversation" : item?.message}</p>

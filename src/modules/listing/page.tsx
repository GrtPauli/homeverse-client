import { Button, DashboardLayout, SelectInput, TextInput } from '@/components'
    ...
    <DashboardLayout page="listings">
      <div className="px-10 w-full">
        <div className="bg-light-white shadow-lg py-10 px-10">
          ...
          <p className='mb-8 text-sm text-colors-cadet'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eos, hic. Nesciunt explicabo repudiandae inventore quos.</p>
            ...
            {(props: FormikProps<any>) => (
              <Form>
                ...
                <div className='mt-10'>
                  ...
                  <p className='text-sm text-colors-cadet mb-5 leading-7'>Potential buyers will contact you through the email address you use to register on Zillow. You must also add your phone number to the listing here.</p>
                ...
                <div className='mt-10'>
                  ...
                  <div className="flex justify-between gap-8 mb-5">
                    ...
                    <TextInput label="Year Built" name="yearBuilt" placeHolder='Enter year built' />
                  </div>
                ...
                <div className='flex justify-end items-center gap-5 mt-10'>
                  ...
                  <Button title="Cancel Posting" fullWidth={false}/>
                </div>
              </Form>
            )}
          </Formik>

        ...
        <div className="flex flex-col gap-10">
          <div>
            ...
            <div className="flex gap-10">
              <div className="flex flex-col gap-5">
                ...
                <AppRadioInput name="basement" label="Partially Finished" value='Partially Finished' />
              </div>
              <div className="flex flex-col gap-5">
          ...
          <div>
            ...
            <div className="flex gap-10">
              ...
              <div className="flex flex-col gap-5">
                ...
                <AppCheckInput name="floorCovering" label="Linoleum / Vinyl" value='Linoleum / Vinyl' />
          ...
          <div>
            ...
            <div className="flex gap-10">
              ...
              <div className="flex flex-col gap-5">
                <AppCheckInput name="appliances" label="Garbage Disposal" value='Garbage Disposal' />
          ...
          <div>
            ...
            <div className="flex gap-10">
              ...
              <div className="flex flex-col gap-5">
                ...
                <AppCheckInput name="indoorFeatures" label="Intercom System" value='Intercom System' />
              </div>
              <div className="flex flex-col gap-5">
                <AppCheckInput name="indoorFeatures" label="Jetted Hub" value='Jetted Hub' />
                <AppCheckInput name="indoorFeatures" label="Security System" value='Security System' />
                <AppCheckInput name="indoorFeatures" label="Skylights" value='Skylights' />
              </div>
              <div className="flex flex-col gap-5">
                <AppCheckInput name="indoorFeatures" label="Vaulted Ceilling" value='Vaulted Ceilling' />
      ...
      <div className="flex justify-between px-6 pt-3 pb-5">
        ...
        <div className="flex flex-col gap-10">
          <div>
            ...
            <div className="flex gap-10">
              <div className="flex flex-col gap-5">
                <AppCheckInput name="buildingAmenities" label="Assisted Living Community" value='Assisted Living Community' />
                <AppCheckInput name="buildingAmenities" label="Basketball Court" value='Basketball Court' />
                <AppCheckInput name="buildingAmenities" label="Controlled Access" value='Controlled Access' />
                <AppCheckInput name="buildingAmenities" label="Sports Court" value='Sports Court' />
              </div>
              <div className="flex flex-col gap-5">
                <AppCheckInput name="buildingAmenities" label="Disabled Access" value='Disabled Access' />
              ...
              <div className="flex flex-col gap-5">
                <AppCheckInput name="buildingAmenities" label="Fitness Center" value='Fitness Center' />
                <AppCheckInput name="buildingAmenities" label="Gated Entry" value='Gated Entry' />
                <AppCheckInput name="buildingAmenities" label="Near Transportation" value='Near Transportation' />
                <AppCheckInput name="buildingAmenities" label="Tennis Court" value='Tennis Court' />
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-10">
              ...
              <div className="flex flex-col gap-5">
                <AppRadioInput name="architecturalStyle" label="Queen Anne / Victorian" value='Queen Anne / Victorian' />
                <AppRadioInput name="architecturalStyle" label="Ranch / Rambler" value='Ranch / Rambler' />
                <AppRadioInput name="architecturalStyle" label="Santa Fe / Pueblo Style" value='Santa Fe / Pueblo Style' />
              ...
              <div className="flex flex-col gap-5">
                ...
                <AppRadioInput name="architecturalStyle" label="Contemporary" value='Contemporary' />
          ...
          <div>
            ...
            <div className="flex gap-10">
              <div className="flex flex-col gap-5">
                ...
                <AppCheckInput name="outdoorAmenities" label="Barbecue Area" value='Barbecue Area' />
              ...
              <div className="flex flex-col gap-5">
                ...
                <AppCheckInput name="outdoorAmenities" label="Sprinkler System" value='Sprinkler System' />
              </div>
            </div>
          </div>
        </div>
